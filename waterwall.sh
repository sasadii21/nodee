    ...
    cat <<EOL > /root/$config_name
{
    ...
    "nodes": [
        ...
        {
            "name": "reality_dest",
            "type": "TcpConnectorبرای اطمینان از اینکه متون فارسی در فایل‌ها به درستی نمایش داده شوند، لازم است اطمینان حاصل کنید که انکودینگ فایل‌ها و متغیرهای محلی به درستی تنظیم شده‌اند. همچنین، مطمئن شوید که فایل‌های متنی شما با انکودینگ UTF-8 ذخیره شده‌اند.

در ادامه، اسکریپت کامل را با تنظیمات مناسب برای انکودینگ UTF-8 و رفع مشکلات احتمالی ارائه می‌کنم:

### اسکریپت کامل با فارسی صحیح
...
برای حل مشکل معکوس نوشتن فارسی و اطمینان از اینکه متن به درستی در فایل‌ها نوشته می‌شود، لازم است که به انکودینگ و تنظیمات محلی توجه داشته باشید. با توجه به نیازهای شما، در اینجا یک اسکریپت کامل است که به درستی از انکودینگ UTF-8 استفاده می‌کند و از معکوس نوشتن فارسی جلوگیری می‌کند:

### اسکریپت کامل با پشتیبانی از زبان فارسی
